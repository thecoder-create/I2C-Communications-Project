...
void TCS34727_GET_RGB(RGB_COLOR_HANDLE_t* RGB_COLOR_Instance){
	...
	*/ 
	float div_factor = 255.0 / (float)RGB_COLOR_Instance->C_RAW;
	
	RGB_COLOR_Instance->R = ((float)RGB_COLOR_Instance->R_RAW * div_factor);
  RGB_COLOR_Instance->G = ((float)RGB_COLOR_Instance->G_RAW * div_factor);
  RGB_COLOR_Instance->B = ((float)RGB_COLOR_Instance->B_RAW * div_factor);
