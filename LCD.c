...
static void LCD_Send_CMD(uint8_t cmd){
	...
	cmd_upper = (cmd & UPPER_NIBBLE_MSK); // use UPPER_NIBBLE_MSK here	//cmd & UPPER_NIBBLE_MSK)
	cmd_lower = (cmd << NIBBLE_SHIFT) & UPPER_NIBBLE_MSK; // use UPPER_NIBBLE_MSK here //(cmd << NIBBLE_SHIFT) & UPPER_NIBBLE_MSK 
...
static void LCD_Send_Data(uint8_t data){
	...
	/* Seperate Upper and Lower Nibble */
	data_upper = (data & UPPER_NIBBLE_MSK); // use UPPER_NIBBLE_MSK here	//cmd & UPPER_NIBBLE_MSK)
	data_lower = (data << NIBBLE_SHIFT) & UPPER_NIBBLE_MSK; // use UPPER_NIBBLE_MSK here	//(data << NIBBLE_SHIFT) & UPPER_NIBBLE_MSK 
